...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Attend_It",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9Attend_It11AppDelegate")
...
SWIFT_CLASS("_TtC9Attend_It26TutorialPageViewController")
...
@interface TutorialPageViewController (SWIFT_EXTENSION(Attend_It)) <UIPageViewControllerDelegate>
...
@interface TutorialPageViewController (SWIFT_EXTENSION(Attend_It)) <UIPageViewControllerDataSource>
...
SWIFT_CLASS("_TtC9Attend_It22TutorialViewController")
...
- (IBAction)didTapNextButton:(id _Nonnull)sender;
